...
public class ToolResults extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.25.0-SNAPSHOT of the Cloud Tool Results API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
    ...
    public class Histories {
      ...
      public class Executions {
        ...
        public class Environments {
          ...
          public class Get extends ToolResultsRequest<com.google.toolresults.model.Environment> {
            ...
            protected Get(java.lang.String projectId, java.lang.String historyId, java.lang.String executionId, java.lang.String environmentId) {
              super(ToolResults.this, "GET", REST_PATH, null, com.google.toolresults.model.Environment.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.historyId = com.google.api.client.util.Preconditions.checkNotNull(historyId, "Required parameter historyId must be specified.");
              this.executionId = com.google.api.client.util.Preconditions.checkNotNull(executionId, "Required parameter executionId must be specified.");
          ...
          public class List extends ToolResultsRequest<com.google.toolresults.model.ListEnvironmentsResponse> {
             ...
             */
            protected List(java.lang.String projectId, java.lang.String historyId, java.lang.String executionId) {
              super(ToolResults.this, "GET", REST_PATH, null, com.google.toolresults.model.ListEnvironmentsResponse.class);
              this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
              this.historyId = com.google.api.client.util.Preconditions.checkNotNull(historyId, "Required parameter historyId must be specified.");
              this.executionId = com.google.api.client.util.Preconditions.checkNotNull(executionId, "Required parameter executionId must be specified.");
            }
        ...
        public class Steps {
          ...
          public class AccessibilityClusters extends ToolResultsRequest<com.google.toolresults.model.ListStepAccessibilityClustersResponse> {
           ...
           *        1234567890123456789/steps/bs.1234567890abcdef Required.
            ...
            protected AccessibilityClusters(java.lang.String name) {
              super(ToolResults.this, "GET", REST_PATH, null, com.google.toolresults.model.ListStepAccessibilityClustersResponse.class);
          ...
          public class TestCases {
            ...
            public class Get extends ToolResultsRequest<com.google.toolresults.model.TestCase> {
              ...
              protected Get(java.lang.String projectId, java.lang.String historyId, java.lang.String executionId, java.lang.String stepId, java.lang.String testCaseId) {
                super(ToolResults.this, "GET", REST_PATH, null, com.google.toolresults.model.TestCase.class);
                this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
                this.historyId = com.google.api.client.util.Preconditions.checkNotNull(historyId, "Required parameter historyId must be specified.");
                this.executionId = com.google.api.client.util.Preconditions.checkNotNull(executionId, "Required parameter executionId must be specified.");
                this.stepId = com.google.api.client.util.Preconditions.checkNotNull(stepId, "Required parameter stepId must be specified.");
            ...
            public class List extends ToolResultsRequest<com.google.toolresults.model.ListTestCasesResponse> {
               ...
               */
              protected List(java.lang.String projectId, java.lang.String historyId, java.lang.String executionId, java.lang.String stepId) {
                super(ToolResults.this, "GET", REST_PATH, null, com.google.toolresults.model.ListTestCasesResponse.class);
                this.projectId = com.google.api.client.util.Preconditions.checkNotNull(projectId, "Required parameter projectId must be specified.");
                this.historyId = com.google.api.client.util.Preconditions.checkNotNull(historyId, "Required parameter historyId must be specified.");
                this.executionId = com.google.api.client.util.Preconditions.checkNotNull(executionId, "Required parameter executionId must be specified.");
                this.stepId = com.google.api.client.util.Preconditions.checkNotNull(stepId, "Required parameter stepId must be specified.");
